...
function App() {
  ...
  return (
    <div style={{ backgroundColor: '#040718', minHeight: '100vh', color: 'white', position: 'relative' }}>
      ...
      >
        <button
          ...
          style={{
            padding: '10px 20px',
            background: activeTab === 'kiosk' ? '#2563eb' : 'transparent',
            color: 'white',
            border: activeTab === 'kiosk' ? 'none' : '1px solid rgba(255, 255, 255, 0.2)',
            borderRadius: '8px',
            cursor: 'pointer',
            fontWeight: '600',
